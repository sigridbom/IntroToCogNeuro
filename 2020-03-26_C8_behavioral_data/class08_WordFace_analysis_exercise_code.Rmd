...
m0 <- glmer(rt ~ imgN1 + gender + img*word_score_pc + delay_frames_before + (1|ID) + (1|word) + (1|time), data = WordFace_new, family = Gamma(link='identity'))

m1 <- glmer(rt ~ imgN1 + gender + img*word_score_pc_sc + delay_frames_before_sc + (1|ID) + (1|word) + (1|time_sc), data = WordFace_new, family = Gamma(link='identity'))
